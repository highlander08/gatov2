...
const AliveCatImage: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    <path
      d="M 150 140 C 180 140, 180 100, 160 90"
      stroke="url(#aliveCatGradient)"
      fill="none"
      strokeWidth="20"
      strokeLinecap="round"
    />
    <path
      d="M 50 160 C 50 130, 70 110, 100 110 C 130 110, 150 130, 150 160 Z"
      fill="url(#aliveCatGradient)"
    />
    ...
    <path
      d="M 90,102 C 95,108 100,108 100,102"
      stroke="black"
      fill="none"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      d="M 100,102 C 100,108 105,108 110,102"
      stroke="black"
      fill="none"
      strokeWidth="2"
      strokeLinecap="round"
...
const DeadCatImage: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    />
    <path
      d="M 50 180 C 40 100, 80 30, 100 30 C 120 30, 160 100, 150 180 Q 125 170 100 180 Q 75 170 50 180 Z"
      fill="url(#deadCatGradient)"
    />
    <path
      d="M75,85 L95,105 M95,85 L75,105"
      stroke="black"
      strokeWidth="5"
      strokeLinecap="round"
    />
    <path
      d="M125,85 L105,105 M105,85 L125,105"
      stroke="black"
      strokeWidth="5"
      strokeLinecap="round"
    />
...
const VialImage: React.FC<{ isBroken: boolean; className?: string }> = ({
  isBroken,
  className,
}) => {
  if (isBroken) {
    return (
      <svg
        viewBox="0 0 100 100"
        className={className}
        aria-label="Frasco de veneno quebrado"
      >
        <path
          d="M 10 95 C 30 90, 70 100, 90 95 Q 50 105 10 95 Z"
          fill="#16a34a"
          opacity="0.8"
        />
        <path
          d="M 30 85 L 40 50 L 25 40"
          fill="none"
          stroke="#67e8f9"
          strokeWidth="3"
          strokeLinecap="round"
  ...
  return (
    <svg
      viewBox="0 0 100 100"
      className={className}
      aria-label="Frasco de veneno intacto"
    >
      <path
        d="M 30 90 L 30 40 Q 30 25 45 25 L 55 25 Q 70 25 70 40 L 70 90 Z"
        fill="#67e8f9"
        fillOpacity="0.5"
        stroke="#0891b2"
        strokeWidth="2"
...
export const QuantumBox: React.FC<QuantumBoxProps> = ({
  appState,
  catState,
}) => {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {isPreSimulation && (
          ...
          >
            ...
            <VialImage isBroken={false} className="w-12 h-12" />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <motion.div
        ...
        animate={isSuperposition ? "superposition" : "default"}
      >
        {/* Top (Lid) */}
        <motion.div
        ...
        <div
          ...
          style={{
            transform: `translateY(${HALF_SIZE_REM}rem) rotateX(-90deg)`,
          }}
        />
        ...
        <div
          ...
          style={{
            transform: `translateZ(-${HALF_SIZE_REM}rem) rotateY(180deg)`,
          }}
        />
        ...
        <div
          ...
          style={{
            transform: `translateX(-${HALF_SIZE_REM}rem) rotateY(-90deg)`,
          }}
        />
        ...
        >
          ...
          <AnimatePresence>
            {(isSuperposition ||
              (isRevealing && catState === CatState.ALIVE)) && (
              <motion.div
          ...
          {isRevealing && catState === CatState.DEAD && (
            <div
              className="absolute inset-0 bg-red-900/50 rounded-lg animate-pulse"
