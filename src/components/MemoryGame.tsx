  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-8 animate-fade-in w-full max-w-2xl mx-auto p-4 mt-8">
      ...
      <div className="flex flex-col items-center gap-4 order-2">
        <div className="text-5xl font-bold text-cyan-300 tabular-nums text-center" style={{ textShadow: '0 0 8px #06b6d4' }}>
          ...
          {COLORS.map((color, index) => (
             <motion.div 
              ...
              <motion.div
                ...
                `}
                whileHover={isPlayerTurn ? { scale: 1.1, filter: "brightness(1.2)" } : {}}
